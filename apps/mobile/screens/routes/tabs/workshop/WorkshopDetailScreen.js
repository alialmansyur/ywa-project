...
const DEFAULT_STATIONS = [
  ...
  { id: 4, step_code: 'INSPECTION_PKB', title: 'Create PKB', status: 'pending', start_time: '-', end_time: '-' },
  { id: 5, step_code: 'CHECKING', title: 'Pengecekan Unit', status: 'pending', start_time: '-', end_time: '-' },
  { id: 6, step_code: 'CREATE_WO', title: 'Pembuatan WO & Jobcard', status: 'pending', start_time: '-', end_time: '-' },
  { id: 7, step_code: 'WAITING_BAY', title: 'Antrian / Waiting Bay', status: 'pending', start_time: '-', end_time: '-' },
