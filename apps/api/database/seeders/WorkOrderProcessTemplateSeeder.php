        ...
        foreach ($workshopBayTemplates as $templateData) {
            $this->upsertTemplate([
                ...
                'steps' => [
                    ...
                    ['order' => 40, 'code' => 'INSPECTION_PKB', 'name' => 'Create PKB & Assign Kategori', 'sla' => 45],
                    ['order' => 50, 'code' => 'CHECKING', 'name' => 'Pengecekan Unit', 'sla' => 30],
                    ['order' => 60, 'code' => 'CREATE_WO', 'name' => 'Pembuatan WO & Cetak Jobcard', 'sla' => 30],
                    ['order' => 70, 'code' => 'WAITING_BAY', 'name' => 'Antrian (Waiting Bay)', 'sla' => 60],
